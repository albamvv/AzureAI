...
<p align="left"><img src="./images/Semantic_similarity.png" height="280px"></p>
...
<p align="left"><img src="./images/text_similarity.png" height="280px"></p>


#### Hateful and unfair content
- Criteria: Hate_and_unfairness
- Query: {{item.question}}
<p align="left"><img src="./images/Hateful.png" height="280px"></p>


7. Select **Next** and review your evaluation settings. You should have configured the evaluation to use the travel evaluation dataset to evaluate the **gpt-4o-mini** model for semantic similarity, relevance, F1 score, and hateful and unfair language.
8. Give the evaluation a suitable name, and **Submit** it to start the evaluation process, and wait for it to complete. It may take a few minutes. You can use the **Refresh** toolbar button to check the status.

<p align="left"><img src="./images/evaluation_details.png" height="280px"></p>

9. Open the Data tab to view per-item scores and reasoning generated by the evaluator model.
10. When the evaluation has completed, scroll down if necessary to review the results.

<p align="left"><img src="./images/metric_dashboard.png" height="280px"></p>

11. At the top of the page, select the **Data** tab to see the raw data from the evaluation. The data includes the metrics for each input as well as explanations of the reasoning the gpt-4o model applied when assessing the responses.

## 5.Results and conclusions


The AI-assisted evaluation demonstrates that the deployed model performs well on the selected test set, achieving a 100% relevance score across all queries. This indicates that the model consistently provided responses that were aligned with the intent of each question and stayed on topic.

However, it is important to interpret this result with caution:

- The test dataset is small (5 items), which limits statistical robustness.
- Relevance alone does not assess factual accuracy, reasoning quality, or hallucination risk.
- The evaluation does not cover safety constraints, fairness, or bias behavior under more complex scenarios.

Overall, the results confirm that the model behaves appropriately within the limited scope of this test and can serve as a baseline for more extensive evaluations.

---

## 6. Next Steps

To build a more complete understanding of the model’s performance and suitability for production scenarios, consider the following steps:

### 1. Expand the evaluation dataset
Increase the number and variety of test cases. Include:
- edge cases
- ambiguous queries
- domain-specific questions
- multilingual inputs (if relevant)

Larger datasets improve reliability and help detect subtle failure patterns.

### 2. Add additional evaluation metrics
Beyond relevance, incorporate:
- **Semantic similarity** to measure alignment with expected responses  
- **F1 score** for structured outputs  
- **Coherence and helpfulness** for conversational quality  
- **Groundedness** to detect hallucinations  

Azure AI Foundry supports most of these through AI-assisted evaluators.

### 3. Perform safety and risk assessments
Evaluate the model under:
- safety filters
- protected categories
- potential harmful or unethical prompts
- fairness and bias scenarios

This helps ensure compliance with corporate governance and responsible AI standards.

### 4. Introduce human-in-the-loop review
Human evaluation provides deeper qualitative insight on:
- clarity  
- usability  
- tone  
- factual correctness  

Especially important in high-risk or customer-facing applications.

### 5. Compare models and prompt variations
Run the same dataset against:
- alternative models (gpt-4o vs gpt-4o-mini vs fine-tuned models)
- different system message configurations
- alternative prompt engineering patterns

This enables data-driven model selection.

### 6. Monitor performance during deployment
If the model is integrated into an application, implement:
- logging of real user queries  
- continuous evaluation  
- drift detection  
- quota and cost monitoring  

This ensures alignment with expected performance over time.

---

These next steps will help transition from basic validation to a more rigorous, enterprise-grade assessment aligned with responsible AI principles and production-readiness standards.
